...
public class AssignRoles {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  driver.findElement(By.id("j_idt70:j_idt75:2:j_idt82")).click();
	  driver.findElement(By.id("j_idt70:j_idt75:1:j_idt82")).click();
	  ...
	  assertTrue(isElementPresent(By.xpath("//table[@id='j_idt70:j_idt75']/tbody/tr/td[3]")));
