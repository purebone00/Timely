...
public class AddARowPressBackButton {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  //verify that the values are not persisted, after hitting the back button
	  assertEquals("0", driver.findElement(By.xpath("//table[@id='j_idt54:j_idt51']/tbody/tr/td[6]")).getText());
	  assertEquals("0", driver.findElement(By.xpath("//table[@id='j_idt54:j_idt51']/tbody/tr/td[7]")).getText());
	  assertEquals("0", driver.findElement(By.xpath("//table[@id='j_idt54:j_idt51']/tbody/tr/td[8]")).getText());
	  assertEquals("0", driver.findElement(By.xpath("//table[@id='j_idt54:j_idt51']/tbody/tr/td[9]")).getText());
	  assertEquals("0", driver.findElement(By.xpath("//table[@id='j_idt54:j_idt51']/tbody/tr/td[10]")).getText());
  }
