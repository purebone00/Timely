...
public class ViewWorkPackageEstimates {
  ...
  public void loginAdmin() throws Exception {
	  driver.get(baseUrl + "/Timely/faces/login.xhtml?expired=true");
	    ...
	    driver.findElement(By.id("input_j_idt16:inputUserName")).sendKeys("Ryan");
	    driver.findElement(By.id("input_j_idt16:inputPassword")).clear();
	    driver.findElement(By.id("input_j_idt16:inputPassword")).sendKeys("Comp@4911");
	    driver.findElement(By.linkText("Project Manager")).click();
	    assertEquals("Weekly Manager Reports", driver.findElement(By.cssSelector("td")).getText());
  }
