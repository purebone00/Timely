...
public class ViewManageProjects {
  ...
  public void loginAdmin() throws Exception {
	  driver.get(baseUrl + "/Timely/faces/login.xhtml?expired=true");
	    ...
	    assertEquals("111111", driver.findElement(By.cssSelector("td")).getText());
	    assertEquals("111113", driver.findElement(By.cssSelector("tr.even > td")).getText());
