...
public class EditRowMonday25Hours {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  driver.findElement(By.id("input_j_idt54:j_idt56:0:satHours")).sendKeys("25");
	  ...
	  assertEquals("Hours worked on Saturday must be between 0 and 24", driver.findElement(By.cssSelector("span.bf-message-detail")).getText());
