...
public class AssignRespEngToProject {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  //double check responsible enginner reports
	  driver.findElement(By.id("input_j_idt16:inputUserName")).sendKeys("100004");
	  driver.findElement(By.id("input_j_idt16:inputPassword")).clear();
	  driver.findElement(By.id("input_j_idt16:inputPassword")).sendKeys("Comp@4911");
	  driver.findElement(By.linkText("Project Manager")).click();
	  
	  assertEquals("Responsible Engineer Reports", driver.findElement(By.cssSelector("h1")).getText());
