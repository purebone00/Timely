...
public class Show25Entries {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  new Select(driver.findElement(By.name("j_idt48_length"))).selectByVisibleText("25");
	
	  assertEquals("Showing 1 to 25 of 200 entries", driver.findElement(By.id("j_idt48_info")).getText());
