//Deprecated
//Test if you can delete all rows in a fresh timesheet
//Deprecated, ability to delete all rows removed
//Requirements: sql112
...
public class TestPageLoad {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  driver.findElement(By.id("input_j_idt16:inputUserName")).clear();
	    ...
	    //remove rows in default timesheet
	    ...
	    //table should have entry undefined
	    assertEquals("undefined", driver.findElement(By.xpath("//table[@id='j_idt233:j_idt146']/tbody/tr/td[9]")).getText());
