...
public class DeleteAdminAsAdmin {
  ...
  @Test
  public void DeleteAdminAsAdminTest() throws Exception {
	  driver.get(baseUrl + "/Timely/faces/login.xhtml?expired=true");
	    ...
	    assertFalse(driver.findElement(By.cssSelector("BODY")).getText().matches("Demote"));
  }
