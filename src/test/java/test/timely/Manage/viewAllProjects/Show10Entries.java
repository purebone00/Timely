...
public class Show10Entries {
  ...
  public void loginAdmin() throws Exception {
	  ...
	  driver.findElement(By.id("input_j_idt16:inputUserName")).clear();
	    ...
	    new Select(driver.findElement(By.name("j_idt50:j_idt51_length"))).selectByVisibleText("10");
	    assertEquals("Showing 1 to 10 of 200 entries", driver.findElement(By.id("j_idt50:j_idt51_info")).getText());
  }
